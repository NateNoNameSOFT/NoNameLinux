...
bash -e $DIST_ROOT/build-env/build-scripts/mount-virt.sh
...
chroot "$LFS" /usr/bin/env -i   \
    ...
    /dist/build-env/build-scripts/finish-chroot.sh

bash -e $DIST_ROOT/build-env/build-scripts/umount-virt.sh
...
tar -cJpf $DIST_ROOT/build-env/dist-temp-tools.txz .